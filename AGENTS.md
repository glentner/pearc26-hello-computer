...
Published web:
- `docs/` - GitHub Pages publishing source (served from `main`, `/docs`). `docs/index.html` is a generated byte-copy of `.agents/factory/getting-started.html` (regenerate with `make pages`); `.nojekyll` serves it verbatim. Live at https://glentner.github.io/pearc26-hello-computer/
...
# Sync the GitHub Pages source (docs/index.html) from .agents/factory/getting-started.html
make pages
